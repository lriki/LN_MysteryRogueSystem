...
実行中の速度変化にと割り込みについて
----------
すばやさ草を飲んだり、倍速の杖の効果を得た場合は、現在の Run 内で、
- 未行動かつ同一 速度 の終端に Unit を追加する。
...
Run 内の マニュアル行動可能な Unit に対して、マニュアル行動Command を送信する。
...
Run 内の未行動 Unit に対して、AIマイナーアクションCommand を送信する。
...
Run 内の未行動 Unit に対して、AIメジャーアクションCommand を送信する。
