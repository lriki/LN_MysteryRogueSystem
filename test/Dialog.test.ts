...
test("Dialog.FeetDialogSequelTiming", () => {
    ...
    const exitPoint1 = SEntityFactory.newEntity(DEntityCreateInfo.makeSingle(REData.getEntity("kObject_ExitPoint_A").id, [], ""));
    REGame.world._transferEntity(exitPoint1, floorId, 11, 10);
