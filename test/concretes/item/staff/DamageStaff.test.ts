...
test("concretes.item.staff.DamageStaff.basic", () => {
    TestEnv.newGame();
    ...
    // アイテム 入手
    const item1 = SEntityFactory.newEntity(DEntityCreateInfo.makeSingle(MRData.getEntity("kEntity_いかずちの杖_A").id, [], "item1"));
