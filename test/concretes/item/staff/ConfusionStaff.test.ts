...
test("concretes.item.staff.ConfusionStaff.basic", () => {
    TestEnv.newGame();
    ...
    // アイテム 入手
    const item1 = SEntityFactory.newEntity(DEntityCreateInfo.makeSingle(REData.getEntity("kEntity_パニックの杖_A").id, [], "item1"));
