...
test("concretes.enemy.Rust", () => {
    ...
    const inventory2 = actor1.getEntityBehavior(LInventoryBehavior);
    ...
    // 盾 入手
    const shield1 = SEntityFactory.newEntity(DEntityCreateInfo.makeSingle(TestEnv.EntityId_Shield1, [], "weapon1"));
