...
test('TurnOrderTable', () => {
    ...
    enemy1.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy2.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy3.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy4.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy5.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy6.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy7.addState(RESystem.createState(RESystem.states.debug_MoveRight));
    ...
    enemy8.addState(RESystem.createState(RESystem.states.debug_MoveRight));
