...
//
//------------------------------------------------------------------------------
// ■構造物 (モンスターハウス等) の指定方法について
// あるフロアに「そもそもモンスターハウスを生成するか」といった設定は
// TerrainSettings.js で行います。
// FloorPresets.js では、そちらの設定によりモンスターハウスが生成されることが決まった後、
// 「ではその中身は具体的にどうするか(通常MHか、特殊MHか)」を設定します。
//
// 注意点として、TerrainSettings.js にモンスターハウスの設定があるが、
// FloorPresets.js には設定が無い場合、モンスターハウスは生成されません。
//
//==============================================================================
db.floorPresets = {
