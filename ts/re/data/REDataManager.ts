...
export class REDataManager {
    ...
    private static setupCommonData(next: NextFunc) {
        ...
        REBasics.actions = {
            ...
            ForwardFloorActionId: REData.addAction("すすむ"),
            BackwardFloorActionId: REData.addAction("戻る"),
            EquipActionId: REData.addAction("装備", 1000),
            EquipOffActionId: REData.addAction("はずす"),
            ...
            WaveActionId: REData.addAction("振る", 1000),
