...
export class REDataManager
{
    ...
    static setupCommonData() {
        ...
        REData.parameters = [
            ...
            REData_Parameter.makeBuiltin(13, "gold", "Gold", -1, 999999, 10, Infinity),
        ];
        DBasics.params = {
            ...
            upgradeValue: REData.parameters.findIndex(x => x.code == "UpgradeValue"),
            remaining: REData.parameters.findIndex(x => x.code == "Remaining"),
            capacity: REData.parameters.findIndex(x => x.code == "Capacity"),
