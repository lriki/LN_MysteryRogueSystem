 ...
 */
export class BlurFilterPass extends PIXI.Filter
{
    horizontal: boolean;
    _quality: number;
    passes: number;
    ...
    //apply(filterManager: PIXI.systems.FilterSystem, input: PIXI.RenderTexture, output: PIXI.RenderTexture, clear: boolean | PIXI.CLEAR_MODES): void
