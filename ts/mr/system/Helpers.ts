...
export class Helpers {
    ...
    public static getLooksToFactionType(subject: LEntity, target: LEntity): DFactionType {
        if (this.isFriend(subject, target)) {
            return DFactionType.Friendly;
        }
        else if (this.isHostile(subject, target)) {
            return DFactionType.Hostile;
        }
        else {
            return DFactionType.Neutral;
        }
    }
