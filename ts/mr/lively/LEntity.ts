...
import { DEntity, DEntityId, DEntityNamePlate, DIdentificationDifficulty } from "ts/mr/data/DEntity";
...
import { DBlockLayerKind, DSpecificEffectId, DEntityKindId, DSubComponentEffectTargetKey, DRaceId, DActionId, DParameterId, DAnimationId } from "../data/DCommon";
